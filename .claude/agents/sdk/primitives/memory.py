...
Integrates with Claude Code's .claude/memory/ system.
...
class Memory:
    """
    Claude Code Memory integration for Agent SDK

    Provides agents with persistent storage for preferences, decisions, and learnings.
    Stores data in .claude/memory/ for cross-session persistence.
    """

    def __init__(self, agent_name: str, memory_dir: str = ".claude/memory"):
        """
