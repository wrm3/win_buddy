---
description: "Capture an idea to IDEA_BOARD.md"
---

Capture an idea to IDEA_BOARD.md: {{args}}
...
### 1. Parse the Idea
Extract from `{{args}}` (or ask if unclear):
...
## Remember
- Ideas are NOT tasks — never create a task file from this workflow
