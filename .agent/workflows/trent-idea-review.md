---
description: "Review IDEA_BOARD.md and evaluate ideas for promotion or shelving"
---

Review IDEA_BOARD.md: {{args}}
...
## Arguments
- `{{args}}` can specify a filter: `feature`, `monetization`, `ready`, `all`, or a specific IDEA-NNN
