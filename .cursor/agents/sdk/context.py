...
class AgentContext:
    ...
    def save(self, context_dir: Optional[Path] = None) -> Path:
        ...
        Args:
            context_dir: Directory to save context (default: .cursor/agent_context/active)

        Returns:
            Path to saved context file
        """
        if context_dir is None:
            context_dir = Path(".cursor/agent_context/active")
    ...
    def load(cls, workflow_id: str, context_dir: Optional[Path] = None) -> "AgentContext":
        ...
        Args:
            ...
            context_dir: Directory to load from (default: .cursor/agent_context/active)
    ...
    def archive(self) -> Path:
        ...
        archive_dir = Path(".cursor/agent_context/archived")
        ...
        active_file = Path(".cursor/agent_context/active") / f"{self.workflow_id}.json"
    ...
    def cleanup_expired(cls, context_dir: Optional[Path] = None):
        ...
        Args:
            context_dir: Directory to clean (default: .cursor/agent_context/active)
        """
        if context_dir is None:
            context_dir = Path(".cursor/agent_context/active")
