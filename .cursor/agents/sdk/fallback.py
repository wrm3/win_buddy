...
class FallbackHandler:
    ...
    def __init__(self,
        ...
        """
        self.log_dir = log_dir or Path(".cursor/agents/sdk/logs")
        self.context_dir = context_dir or Path(".cursor/agent_context/json")
    ...
    def call_prompt_agent(self,
        ...
        try:
            ...
            agent_file = Path(f".cursor/agents/prompt-based/{agent_type}.md")

            if not agent_file.exists():
                # Try without hyphen
                agent_file = Path(f".cursor/agents/{agent_type}.md")
...
class HybridAgentInvoker:
    ...
    def auto_detect_agent_type(self, agent_name: str) -> AgentType:
        ...
        sdk_agent_file = Path(f".cursor/agents/sdk/agents/{agent_name}.py")
        ...
        prompt_agent_file = Path(f".cursor/agents/prompt-based/{agent_name}.md")
