...
class AgentFilesCheck(HealthCheck):
    ...
    def __init__(self, agent_dir: Path = None):
        ...
        self.agent_dir = agent_dir or Path(".cursor/agents")
...
class ContextStorageCheck(HealthCheck):
    ...
    def __init__(self, context_dir: Path = None):
        ...
        self.context_dir = context_dir or Path(".cursor/agent_context")
...
class HealthMonitor:
    ...
    def validate_agent(self, agent_name: str) -> Tuple[bool, str]:
        ...
        """
        # Check SDK agent
        sdk_agent = Path(f".cursor/agents/sdk/agents/{agent_name}.py")
        if sdk_agent.exists():
            return True, f"SDK agent available: {agent_name}"

        # Check prompt-based agent
        prompt_agent = Path(f".cursor/agents/prompt-based/{agent_name}.md")
        if prompt_agent.exists():
            return True, f"Prompt-based agent available: {agent_name}"

        # Check legacy location
        legacy_agent = Path(f".cursor/agents/{agent_name}.md")
