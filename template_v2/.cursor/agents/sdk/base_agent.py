...
class BaseAgent(ABC):
    ...
    def __init__(
        ...
        Args:
            ...
            tools: List of Cursor tools this agent can use
            enable_memory: Enable access to Cursor Memory system
            enable_plugins: Enable access to Cursor Plugins
    ...
    def _setup_logger(self) -> logging.Logger:
        ...
        log_dir = Path(".cursor/logs/agents")
    ...
    def invoke_tool(
        ...
        **kwargs
        ...
        """
        Invoke a Cursor tool with error handling.

        Wrapper around Cursor tools (Read, Write, Edit, Bash, etc.)
