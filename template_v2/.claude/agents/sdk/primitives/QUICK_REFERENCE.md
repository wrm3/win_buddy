...
**Storage**: `.claude/memory/agent_decisions/{agent_name}/memory.json`
...
**Hook Scripts**: `.claude/hooks/{event}.sh`
...
- Check `.claude/memory/agent_decisions/` exists
- Verify file permissions

**Commands not found?**
- Verify `.claude/commands/` contains command files
- Use `list_available()` to check

**Hooks not executing?**
- Verify `.claude/hooks/` contains scripts
