...
Usage:
    python .claude/agents/sdk/context/validate_installation.py
...
def check_directories():
    ...
    required_dirs = [
        ...
        ".claude/agent_context/sdk",
        ".claude/agent_context/json",
        ".claude/agent_context/active",
        ".claude/agent_context/archived",
        ".claude/agents/sdk/context",
        ".claude/agents/prompt-based",
        ".claude/memory/agent_decisions",
        ".claude/hooks"
    ]
...
def check_files():
    ...
    required_files = [
        ".claude/agents/sdk/context/__init__.py",
        ".claude/agents/sdk/context/schema.py",
        ".claude/agents/sdk/context/manager.py",
        ".claude/agents/sdk/context/utils.py",
        ".claude/agents/sdk/context/examples.py",
        ".claude/agents/sdk/context/README.md",
        ".claude/agents/prompt-based/context_adapter.py",
        ".claude/agents/sdk/requirements.txt"
    ]
...
def check_documentation():
    ...
    readme_path = Path(".claude/agents/sdk/context/README.md")
...
def main():
    ...
    if all_passed:
        ...
        print("\nNext steps:")
        print("  1. Install dependencies: pip install -r .claude/agents/sdk/requirements.txt")
        print("  2. Run examples: python .claude/agents/sdk/context/examples.py")
        print("  3. Read documentation: .claude/agents/sdk/context/README.md")
        return 0
    else:
